...
namespace DND.Shared.Entities.Characters.Skills
{
    public class Skill : Nameable
    {
        ...
        public static Skill AnimalHandling = new Skill { ID = 1, Name = "Animal Handling", Value = 0, BaseStat = WIS };
        ...
        public static Skill SleightOfHand = new Skill { ID = 15, Name = "Sleight Of Hand", Value = 0, BaseStat = DEX };
